...
entity TopLevel is
	port(
	    ...
	    LogicUSBFifoRead_S         : in    std_logic;
        LogicUSBFifoEmpty_S        : out    std_logic;
        LogicUSBFifoAlmostEmpty_S  : out    std_logic;
--        LogicUSBFifoFull_S         : in    std_logic;
--        LogicUSBFifoAlmostFull_S   : in    std_logic;
--        LogicUSBFifoDataIn_D     : std_logic_vector(FULL_EVENT_WIDTH - 1 downto 0);
--        LogicUSBFifoDataIn_D     : std_logic_vector(FULL_EVENT_WIDTH - 1 downto 0);
        LogicUSBFifoDataOut_D      : out std_logic_vector(USB_FIFO_WIDTH - 1 downto 0);
...
--	end generate doubleFIFOConnect;
    ...
    DVSAERConfig_DRun_SORAPSADCConfig_DRun_S <= DVSAERConfig_D.Run_S or APSADCConfig_D.Run_S or MultiplexerConfig_D.ForceChipBiasEnable_S;
...
--    NOTSPISlaveSelectSync_SB <= not SPISlaveSelectSync_SB;
--	led3Buffer : entity work.SimpleRegister
--		port map(
--			Clock_CI     => LogicClock_C,
--			Reset_RI     => LogicReset_R,
--			Enable_SI    => '1',
--			Input_SI(0)  => NOTSPISlaveSelectSync_SB,
--			Output_SO(0) => LED3_SO);
...
--			NewReset_RO     => ADCReset_R);
    ...
    LogicUSBFifoControlIn_S.ReadSide.Read_S <= LogicUSBFifoRead_S;
    LogicUSBFifoEmpty_S <= LogicUSBFifoControlOut_S.ReadSide.Empty_S;
    LogicUSBFifoAlmostEmpty_S <= LogicUSBFifoControlOut_S.ReadSide.AlmostEmpty_S;
