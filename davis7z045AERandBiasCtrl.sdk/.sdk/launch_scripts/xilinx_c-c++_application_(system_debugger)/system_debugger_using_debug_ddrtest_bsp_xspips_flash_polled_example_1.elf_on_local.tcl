...
rst -processor
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent JTAG-SMT2 210251A515BC"} -index 0
dow E:/PhD_project/vivado_prjs/davisZynq/davis7z045AERandBiasCtrl/davis7z045AERandBiasCtrl.sdk/DDRTest_bsp_xspips_flash_polled_example_1/Debug/DDRTest_bsp_xspips_flash_polled_example_1.elf
