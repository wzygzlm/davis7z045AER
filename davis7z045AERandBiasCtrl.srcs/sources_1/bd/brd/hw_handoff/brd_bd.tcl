...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net count_V [get_bd_pins eventStreamToConstEn_0/count_V] [get_bd_pins system_ila_0/probe6]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets count_V]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net hCnt_V [get_bd_pins eventStreamToConstEn_0/hCnt_V] [get_bd_pins system_ila_0/probe5]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets hCnt_V]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net regY_V [get_bd_pins eventStreamToConstEn_0/regY_V] [get_bd_pins system_ila_0/probe3]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets regY_V]
  connect_bd_net -net skipFlgOutput_V [get_bd_pins eventStreamToConstEn_0/skipFlgOutput_V] [get_bd_pins system_ila_0/probe8]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins EVRawStreamToXYTSStr_0/eventFIFOIn_V_empty_n] [get_bd_pins system_ila_0/probe9] [get_bd_pins util_vector_logic_0/Res]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets util_vector_logic_0_Res]
  connect_bd_net -net vCnt_V [get_bd_pins eventStreamToConstEn_0/vCnt_V] [get_bd_pins system_ila_0/probe4]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets vCnt_V]
