	...
	begin
		...
		case ConfigParamAddress_DI is
			when DAVIS346_CHIPCONFIG_PARAM_ADDRESSES.DigitalMux0_D =>
				ChipConfigReg_DN.DigitalMux0_D                         <= unsigned(ConfigParamInput_DI(tDAVIS346ChipConfig.DigitalMux0_D'range));
			...
			when DAVIS346_CHIPCONFIG_PARAM_ADDRESSES.DigitalMux1_D =>
				ChipConfigReg_DN.DigitalMux1_D                         <= unsigned(ConfigParamInput_DI(tDAVIS346ChipConfig.DigitalMux1_D'range));
			...
			when DAVIS346_CHIPCONFIG_PARAM_ADDRESSES.DigitalMux2_D =>
				ChipConfigReg_DN.DigitalMux2_D                         <= unsigned(ConfigParamInput_DI(tDAVIS346ChipConfig.DigitalMux2_D'range));
			...
			when DAVIS346_CHIPCONFIG_PARAM_ADDRESSES.DigitalMux3_D =>
				ChipConfigReg_DN.DigitalMux3_D                         <= unsigned(ConfigParamInput_DI(tDAVIS346ChipConfig.DigitalMux3_D'range));
			...
			when DAVIS346_CHIPCONFIG_PARAM_ADDRESSES.AnalogMux0_D =>
				ChipConfigReg_DN.AnalogMux0_D                         <= unsigned(ConfigParamInput_DI(tDAVIS346ChipConfig.AnalogMux0_D'range));
			...
			when DAVIS346_CHIPCONFIG_PARAM_ADDRESSES.AnalogMux1_D =>
				ChipConfigReg_DN.AnalogMux1_D                         <= unsigned(ConfigParamInput_DI(tDAVIS346ChipConfig.AnalogMux1_D'range));
			...
			when DAVIS346_CHIPCONFIG_PARAM_ADDRESSES.AnalogMux2_D =>
				ChipConfigReg_DN.AnalogMux2_D                         <= unsigned(ConfigParamInput_DI(tDAVIS346ChipConfig.AnalogMux2_D'range));
			...
			when DAVIS346_CHIPCONFIG_PARAM_ADDRESSES.BiasMux0_D =>
				ChipConfigReg_DN.BiasMux0_D                         <= unsigned(ConfigParamInput_DI(tDAVIS346ChipConfig.BiasMux0_D'range));
