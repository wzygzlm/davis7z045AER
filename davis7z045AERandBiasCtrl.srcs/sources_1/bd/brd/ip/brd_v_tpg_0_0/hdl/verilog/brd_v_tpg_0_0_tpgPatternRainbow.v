...
module brd_v_tpg_0_0_tpgPatternRainbow (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg  signed [15:0] x_read_reg_616;
reg  signed [15:0] x_read_reg_616_pp0_iter1_reg;
reg  signed [15:0] x_read_reg_616_pp0_iter2_reg;
reg  signed [15:0] x_read_reg_616_pp0_iter3_reg;
wire   [0:0] tmp_fu_122_p2;
wire   [0:0] icmp_fu_138_p2;
wire   [7:0] p_tmp_s_fu_199_p3;
reg   [7:0] p_tmp_s_reg_649;
reg   [7:0] p_tmp_s_reg_649_pp0_iter2_reg;
wire   [7:0] g_fu_231_p3;
reg   [7:0] g_reg_656;
reg   [7:0] g_reg_656_pp0_iter2_reg;
wire   [7:0] b_fu_263_p3;
reg   [7:0] b_reg_662;
reg   [7:0] b_reg_662_pp0_iter2_reg;
wire   [13:0] tmp_195_cast_cast_ca_fu_277_p1;
reg   [13:0] tmp_195_cast_cast_ca_reg_669;
wire  signed [15:0] grp_fu_574_p3;
reg  signed [15:0] tmp_63_reg_674;
wire  signed [15:0] grp_fu_582_p3;
reg  signed [15:0] tmp_67_reg_679;
wire  signed [15:0] grp_fu_598_p3;
reg  signed [15:0] tmp4_reg_684;
wire   [7:0] Scalar_val_0_V_writ_fu_498_p3;
reg   [7:0] Scalar_val_0_V_writ_reg_689;
wire   [7:0] tmp_25_fu_512_p3;
reg   [7:0] tmp_25_reg_694;
wire   [7:0] Scalar_val_2_V_writ_fu_526_p3;
reg   [7:0] Scalar_val_2_V_writ_reg_700;
...
wire   [7:0] tmp_207_cast_fu_283_p1;
wire  signed [15:0] tmp_193_cast_fu_274_p1;
wire   [16:0] grp_fu_606_p3;
wire   [14:0] tmp_66_fu_301_p3;
wire   [16:0] tmp_202_cast_fu_308_p1;
wire   [16:0] tmp_204_cast_fu_312_p1;
wire   [16:0] tmp_68_fu_315_p2;
wire   [14:0] tmp_69_fu_331_p3;
wire   [16:0] tmp_206_cast_fu_338_p1;
...
wire   [7:0] Scalar_val_1_V_writ_fu_543_p3;
...
wire  signed [5:0] grp_fu_598_p0;
wire   [7:0] grp_fu_598_p1;
wire  signed [15:0] grp_fu_598_p2;
wire   [5:0] grp_fu_606_p0;
...
wire    ap_enable_pp0;
wire  signed [15:0] grp_fu_574_p20;
wire   [13:0] grp_fu_598_p10;
wire   [16:0] grp_fu_606_p20;
...
brd_v_tpg_0_0_tpgPatternRainbowvdy #(
    .DataWidth( 9 ),
    .AddressRange( 2048 ),
    .AddressWidth( 11 ))
...
brd_v_tpg_0_0_v_tpg_mac_muladd_wdI #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 8 ),
...
brd_v_tpg_0_0_v_tpg_mac_muladd_xdS #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 9 ),
    .din1_WIDTH( 8 ),
...
brd_v_tpg_0_0_v_tpg_mac_muladd_yd2 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 7 ),
    .din1_WIDTH( 8 ),
...
brd_v_tpg_0_0_v_tpg_mac_muladd_zec #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 8 ),
...
brd_v_tpg_0_0_v_tpg_mac_muladd_Aem #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 6 ),
    .din1_WIDTH( 8 ),
...
brd_v_tpg_0_0_v_tpg_mac_muladd_Bew #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 6 ),
    .din1_WIDTH( 8 ),
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_ce) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        Scalar_val_0_V_writ_reg_689 <= Scalar_val_0_V_writ_fu_498_p3;
        Scalar_val_2_V_writ_reg_700 <= Scalar_val_2_V_writ_fu_526_p3;
        b_reg_662_pp0_iter2_reg <= b_reg_662;
        g_reg_656_pp0_iter2_reg <= g_reg_656;
        p_tmp_s_reg_649_pp0_iter2_reg <= p_tmp_s_reg_649;
        tmp_195_cast_cast_ca_reg_669[7 : 0] <= tmp_195_cast_cast_ca_fu_277_p1[7 : 0];
        tmp_25_reg_694 <= tmp_25_fu_512_p3;
        x_read_reg_616_pp0_iter2_reg <= x_read_reg_616_pp0_iter1_reg;
        x_read_reg_616_pp0_iter3_reg <= x_read_reg_616_pp0_iter2_reg;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_ce) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        b_reg_662 <= b_fu_263_p3;
        g_reg_656 <= g_fu_231_p3;
        p_tmp_s_reg_649 <= p_tmp_s_fu_199_p3;
        x_read_reg_616 <= x;
        x_read_reg_616_pp0_iter1_reg <= x_read_reg_616;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_ce) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        tmp4_reg_684 <= grp_fu_598_p3;
        tmp_63_reg_674 <= grp_fu_574_p3;
        tmp_67_reg_679 <= grp_fu_582_p3;
    end
end
...
assign Scalar_val_1_V_writ_fu_543_p3 = ((icmp_fu_138_p2[0:0] === 1'b1) ? tmp_25_reg_694 : tmp_28_fu_537_p3);
...
assign ap_return_0 = Scalar_val_0_V_writ_reg_689;

assign ap_return_1 = Scalar_val_1_V_writ_fu_543_p3;

assign ap_return_2 = Scalar_val_2_V_writ_reg_700;
...
assign grp_fu_565_p1 = tmp_191_cast5_cast1_fu_271_p1;

assign grp_fu_565_p2 = 15'd4224;

assign grp_fu_574_p0 = 16'd150;

assign grp_fu_574_p1 = tmp_193_cast_fu_274_p1;

assign grp_fu_574_p2 = grp_fu_574_p20;

assign grp_fu_574_p20 = $unsigned(grp_fu_565_p3);

assign grp_fu_582_p0 = 15'd32725;

assign grp_fu_582_p1 = tmp_191_cast5_cast1_fu_271_p1;

assign grp_fu_589_p0 = 16'd65451;

assign grp_fu_589_p1 = tmp_193_cast_fu_274_p1;

assign grp_fu_598_p0 = 14'd16363;

assign grp_fu_598_p1 = grp_fu_598_p10;

assign grp_fu_598_p10 = b_reg_662;

assign grp_fu_598_p2 = ($signed(16'd65429) * $signed({{1'b0}, {tmp_207_cast_fu_283_p1}}));

assign grp_fu_606_p0 = 14'd29;

assign grp_fu_606_p1 = tmp_195_cast_cast_ca_reg_669;

assign grp_fu_606_p2 = grp_fu_606_p20;

assign grp_fu_606_p20 = $unsigned(tmp_63_reg_674);

assign icmp_fu_138_p2 = ((tmp_53_fu_128_p4 == 7'd0) ? 1'b1 : 1'b0);

assign not_phitmp9_fu_411_p2 = ((tmp_3_fu_321_p4 != 9'd0) ? 1'b1 : 1'b0);
...
assign phitmp8_fu_374_p2 = ((tmp_1_fu_292_p4 != 9'd0) ? 1'b1 : 1'b0);

assign sel_tmp1_fu_487_p2 = (tmp_fu_122_p2 ^ 1'd1);

assign sel_tmp2_fu_492_p2 = (sel_tmp1_fu_487_p2 & phitmp5_fu_449_p2);

assign tmp14_cast_fu_342_p1 = tmp4_reg_684;

assign tmp5_fu_345_p2 = (17'd32896 + tmp_206_cast_fu_338_p1);

assign tmp_13_fu_386_p4 = {{grp_fu_606_p3[15:8]}};
...
assign tmp_18_fu_431_p4 = {{tmp_68_fu_315_p2[15:8]}};

assign tmp_191_cast5_cast1_fu_271_p1 = p_tmp_s_reg_649;

assign tmp_193_cast_fu_274_p1 = $unsigned(g_reg_656);

assign tmp_195_cast_cast_ca_fu_277_p1 = b_reg_662;

assign tmp_19_fu_441_p3 = ((tmp_78_fu_425_p2[0:0] === 1'b1) ? tmp_16_cast_fu_417_p3 : tmp_18_fu_431_p4);

assign tmp_1_fu_292_p4 = {{grp_fu_606_p3[16:8]}};

assign tmp_202_cast_fu_308_p1 = tmp_66_fu_301_p3;

assign tmp_204_cast_fu_312_p1 = $unsigned(tmp_67_reg_679);

assign tmp_206_cast_fu_338_p1 = tmp_69_fu_331_p3;

assign tmp_207_cast_fu_283_p1 = tmp_193_cast_fu_274_p1;

assign tmp_20_fu_463_p4 = {{tmp_70_fu_351_p2[15:8]}};

assign tmp_21_fu_473_p3 = ((tmp_79_fu_455_p3[0:0] === 1'b1) ? 8'd255 : tmp_20_fu_463_p4);

assign tmp_22_fu_481_p3 = ((tmp_fu_122_p2[0:0] === 1'b1) ? p_tmp_s_reg_649_pp0_iter2_reg : tmp_15_fu_403_p3);

assign tmp_24_fu_506_p3 = ((tmp_fu_122_p2[0:0] === 1'b1) ? g_reg_656_pp0_iter2_reg : tmp_19_fu_441_p3);

assign tmp_25_fu_512_p3 = ((sel_tmp2_fu_492_p2[0:0] === 1'b1) ? tmp_19_fu_441_p3 : tmp_24_fu_506_p3);

assign tmp_26_fu_520_p3 = ((tmp_fu_122_p2[0:0] === 1'b1) ? b_reg_662_pp0_iter2_reg : tmp_21_fu_473_p3);

assign tmp_28_fu_537_p3 = ((tmp_80_fu_534_p1[0:0] === 1'b1) ? Scalar_val_2_V_writ_reg_700 : tmp_25_reg_694);

assign tmp_3_fu_321_p4 = {{tmp_68_fu_315_p2[16:8]}};
...
assign tmp_66_fu_301_p3 = {{b_reg_662_pp0_iter2_reg}, {7'd0}};

assign tmp_68_fu_315_p2 = (tmp_202_cast_fu_308_p1 + tmp_204_cast_fu_312_p1);

assign tmp_69_fu_331_p3 = {{p_tmp_s_reg_649_pp0_iter2_reg}, {7'd0}};
...
assign tmp_77_fu_367_p3 = grp_fu_606_p3[32'd16];

assign tmp_78_fu_425_p2 = (($signed(tmp_3_fu_321_p4) < $signed(9'd1)) ? 1'b1 : 1'b0);

assign tmp_79_fu_455_p3 = tmp_70_fu_351_p2[32'd16];

assign tmp_80_fu_534_p1 = x_read_reg_616_pp0_iter3_reg[0:0];
...
always @ (posedge ap_clk) begin
    tmp_195_cast_cast_ca_reg_669[13:8] <= 6'b000000;
end

endmodule //brd_v_tpg_0_0_tpgPatternRainbow
